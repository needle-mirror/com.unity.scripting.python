...
class Channel(object):
    ...
    def poll(self, timeout, interrupter = None):
        ...
        Optionally, provide a socket object to send data to preemptively interrupt 
        the poll operation when written to it"""
        return self.stream.poll(timeout, interrupter)
    def recv(self):
